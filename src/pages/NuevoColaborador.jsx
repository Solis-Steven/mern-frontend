...
export function NuevoColaborador() {
    ...
    const { 
        ...
        colaborador, agregarColaborador,alerta
    } = useProyectos();
    ...
    if(!proyectoActual?._id) return(<Alerta alerta={alerta} />)
    ...
    return(
        <>
            <h1 className="text-4xl font-black">A&atilde;adir Colaborador(a) al proyecto: {proyectoActual?.nombre}</h1>
