...
export const ModalTarea = () => {  
    ...
    const { 
        modalTarea, handleModalTarea, 
        mostrarAlerta, alerta, submitTarea,
        tareaActual 
    } = useProyectos();

    useEffect(() => {
        if(tareaActual?._id) {
            setIdT(tareaActual._id)
            setNombre(tareaActual.nombre);
            setDescripcion(tareaActual.descripcion);
            setFechaEntrega(tareaActual.fechaEntrega?.split("T")[0]);
            setPrioridad(tareaActual.prioridad);
    ...
    const handleSubmit = async(e) => {
        ...
        await submitTarea({idT, nombre, descripcion, fechaEntrega, prioridad, proyecto: id});
        setIdT("");
        setNombre("");
        setDescripcion("");
        setFechaEntrega("");
                            ...
                            <div className="sm:flex sm:items-start">
                                <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                                    ...
                                    >
                                        ...
                                        <input 
                                            type='submit'
                                            value={idT ? "Guardar Cambios" : "Crear Tarea"}
